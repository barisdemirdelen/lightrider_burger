...
class BotNN(object):
    def __init__(self, session):
        ...
        self.inputs = tf.placeholder(dtype=tf.float32, shape=[None, 16, 16, 1], name='inputs')
        ...
        self.algorithm = tf.train.AdamOptimizer(learning_rate=1e-3)
    ...
    def get_cell_tensor(self, reverse_players=False):
        ...
        if reverse_players:
            ...
            cell_tensor[0, p1.row, p1.col, 0] = 1
            cell_tensor[0, p2.row, p2.col, 0] = 0
